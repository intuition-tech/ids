    ...
    <main>
      ...
      <div class="ids__wrapper">
        ...
        <div class="section">
          ...
          <div class="ids__text-width">
            <h3>Сноски</h3>
            <p>
              <code>ids-footnote-link</code> и <code>ids-footnote</code> —
              компоненты для создания всплывающих сносок с автоматической
              нумерацией.
            </p>

            <p>
              Система состоит из двух частей: ссылки-триггера
              (<code>ids-footnote-link</code>) и контейнера с содержимым сноски
              (<code>ids-footnote</code>).
            </p>

            <aside>
              <h4>Как это работает</h4>
              <p>
                Нумерация сносок происходит автоматически по порядку элементов в
                DOM. Первая ссылка получает номер 1, вторая — 2, и так далее.
                Номера отображаются в кружках: неактивная ссылка показывается
                как контурный кружок с границей, а при открытии сноски кружок
                заполняется чёрным цветом с белым номером. Внутри самой сноски
                номер также отображается в чёрном кружке.
              </p>
              <p>
                На десктопе сноска открывается справа от ссылки. На мобильных
                устройствах — внизу экрана в виде модального окна. При клике вне
                сноски или нажатии Escape она закрывается.
              </p>
            </aside>
            ...
            <p>
              Это простой текст с
              <ids-footnote-link>первой сноской</ids-footnote-link>
              и ещё одной
              <ids-footnote-link>второй сноской</ids-footnote-link>
              для демонстрации.
            </p>

            <ids-footnote>
              <p>
                Это содержимое первой сноски. Оно может включать любую разметку:
            ...
            <ids-footnote>
              <p>
                А это вторая сноска. Обратите внимание, что номер появляется
                автоматически.
              </p>
              <p>
                Сноска может содержать несколько параграфов. Если контент
                слишком длинный и не помещается на экране, появится кнопка
                «Закрыть», и прокрутка основной страницы блокируется.
              </p>
            </ids-footnote>

            <div class="ids__space M"></div>

            <p><strong>Структура разметки:</strong></p>
            <div class="ids__space XS"></div>
            <p><code>&lt;p&gt;</code></p>
            <p>Текст с</p>
            <p>
              <code>&lt;ids-footnote-link&gt;</code>ссылкой на сноску<code
                >&lt;/ids-footnote-link&gt;</code
              >
            </p>
            <p>в тексте.</p>
            <p><code>&lt;/p&gt;</code></p>
            <div class="ids__space XS"></div>
            <p><code>&lt;ids-footnote&gt;</code></p>
            <p>
              <code>&lt;p&gt;</code>Содержимое сноски.<code>&lt;/p&gt;</code>
            </p>
            <p><code>&lt;/ids-footnote&gt;</code></p>
            ...
            <aside>
              ...
              <ul>
                <li>
                  Порядок элементов <code>ids-footnote</code> должен совпадать с
                  порядком соответствующих <code>ids-footnote-link</code>
                </li>
                <li>
                  Номер автоматически появляется в начале первого параграфа
                  сноски
                </li>
                <li>Одновременно может быть открыта только одна сноска</li>
                <li>
                  Клик по другой ссылке автоматически закрывает предыдущую
                  сноску
                </li>
              </ul>
            </aside>
      ...
      <div class="ids__wrapper">
        <div class="section">
          <div class="ids__space"></div>
          <div class="ids__text-width">
            <h3><code>.ids__rounded</code></h3>

            <p>
              Модификатор для плавной обрезки углов.
              Обычное скругление грубое и неестественное.
              А это приятное и математическое.
            </p>

            <aside>
              <p>Такие углы скоро можно будет делать стандартным <code>corner-shape: squircle</code>, но пока не все браузеры договорились окончательно.</p>
              <p>
                IDS помогает сделать такие углы небольшим трюком.
                Часто этого достаточно, но если применять скругление к компонентам с границами или тенями, нужно проверить что во всех браузерах эффект работает как ожидается.
              </p>
            </aside>
            <div class="ids__space"></div>
            ...
            <div class="example-container">
              <div class="ids__sequence L gap-L">
                <div class="ids__sequence-item ids__rounded">
            ...
            <p>
              Радиус углов указывается в переменной <code>--ids__radius</code>.
              Его можно задать для всего документа, раздела, или для отдельного элемента.
            </p>
            ...
            <div class="example-container">
              <div class="ids__sequence L gap-L">
                ...
                <div class="ids__sequence-item ids__rounded" style="--ids__radius: 5em">
                  <figure style="margin:0;padding:0">
                    <img src="images/gallery/Photo by Jan van der Wolf_pexels-jan-van-der-wolf-11680885-11986204.jpg" alt="Photo by Jan van der Wolf" />
                  </figure>
                </div>
